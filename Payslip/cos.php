...
$id = $_GET['id'];
$payroll = $conn->query("SELECT w.*, e.fullname as ename, e.position FROM wages_cos w 
INNER JOIN employee_cos e ON w.employee_id = e.id WHERE w.employee_id = $id");
            ...
            <div class="payslip border p-2" id="payslip-content" style="max-width: 600px;">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <div class="row mx-4">
                        ...
                        <div class="row col-12">
                            <p class="col-8 p-0 m-0">Tardiness</p>
                            <p class="col-4 p-0 m-0"><?php echo number_format($row['tardiness'], 2); ?></p>
                        </div>
                        <div class="row col-12">
                        ...
                        <div class="row col-12">
                            ...
                            <p class="col-4 p-0 m-0"><?php echo number_format($row['prawn'], 2); ?></p>
                        </div>
                    </div>
